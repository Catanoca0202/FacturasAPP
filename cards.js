...
function onHomepage(e) {
  ...
  message = 'Para empezar, haz clic en el menu de la parte superior llamado <b>FacturasApp</b> y selecciona la opción <b>Inicio</b>.  '
...
function createCard(text, isHomepage) {
  ...
  var imageUrl = 'https://www.facturasapp.com/Publico/images/logoHead.png' 
  var image = CardService.newImage()
      .setImageUrl(imageUrl)
      .setAltText('FacturasApp')
...
//    .setBottomLabel("BottomLabel");
  ...
  var footer = CardService.newFixedFooter()
      .setPrimaryButton(CardService.newTextButton()
          .setText('Powered by FacturasApp.com')
          .setOpenLink(CardService.newOpenLink()
              .setUrl('https://www.facturasapp.com/')));
